...
public class AccountDAOHandler implements AccountDAO {
    ...
    public void saveCustomer(Customer customer) {
        HashMap<String, Customer> customerCollection = retrieveCustomers();
        String customerId = customer.getCustomerId();
        Customer customer1 = customerCollection.get(customerId);

        if (customer1 == null) {
            customerCollection.put(customerId, customer);
            saveToStorage(StorageType.CUSTOMERS, customerCollection);
        }
    }
